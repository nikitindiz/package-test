...
export declare const buildHooksContractFile: ({ abiToJsImportPath, contractAbiDir, contractAddress, contractEntity, contractName, dir, }: BuildContractEntityFileArgs) => {
    name: string;
    fileName: string;
    filePath: string;
    fileContent: string;
